...
[xbar,ubar,sbar] = misc.create_initialization(prb,2,xbar,ubar,taubar,tvecbar(end));
...
[t,x,u] = disc.simulate_dyn(xbar(:,1),{tvecbar,ubar},@(t,x,u) prb.dyn_func(t,x,u,1.0),[tvecbar(1),tvecbar(end)],prb.Kfine,prb.disc,prb.ode_solver);
...
save('recent_solution','m','rI','vI','qBI','omgB','u','x', ...
