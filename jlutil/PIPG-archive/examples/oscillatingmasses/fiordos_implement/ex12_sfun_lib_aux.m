function ex12_sfun_lib_aux(id,varargin)
% auxiliary file for ex12_sfun_lib
...
try
    bn={'algoInner.init [300x1]','algoInner.maxit [1x1]','algoInner.stopgEps [1x1]','algoOuter.init [200x1]','algoOuter.maxit [1x1]','algoOuter.stopgEps [1x1]'};
