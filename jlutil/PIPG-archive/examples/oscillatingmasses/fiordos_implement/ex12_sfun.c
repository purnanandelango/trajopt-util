...
#include "ex12_solver.c"

#define S_FUNCTION_NAME   ex12_sfun   /**< Name of the S function. */
...
static void mdlInitializeSizes (SimStruct *S)
{
    ...
    ssSetInputPortMatrixDimensions(S, 3, 300, 1);
    ssSetInputPortMatrixDimensions(S, 4, 1, 1);
    ssSetInputPortMatrixDimensions(S, 5, 1, 1);
    ssSetInputPortMatrixDimensions(S, 6, 200, 1);
    ...
    ssSetOutputPortMatrixDimensions(S, 1, 300, 1);
...
{
    /* allocate memory */
    ssGetPWork(S)[0] = (void *) calloc( 1, sizeof(ex12_Params) );
    ssGetPWork(S)[1] = (void *) calloc( 1, sizeof(ex12_Settings) );
    ssGetPWork(S)[2] = (void *) calloc( 1, sizeof(ex12_Result) );
    ssGetPWork(S)[3] = (void *) calloc( 1, sizeof(ex12_Work) );
    
    /* call init */
    ex12_init( (ex12_Params *) ssGetPWork(S)[0], (ex12_Settings *) ssGetPWork(S)[1], (ex12_Result *) ssGetPWork(S)[2], (ex12_Work *) ssGetPWork(S)[3] );
    
    /* adapt settings (from mask) */
    {
        ex12_Settings *settings = (ex12_Settings *) ssGetPWork(S)[1];
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    ex12_Params *params = (ex12_Params *) ssGetPWork(S)[0];
    ex12_Settings *settings = (ex12_Settings *) ssGetPWork(S)[1];
    ex12_Result *result = (ex12_Result *) ssGetPWork(S)[2];
    ex12_Work *work = (ex12_Work *) ssGetPWork(S)[3];
