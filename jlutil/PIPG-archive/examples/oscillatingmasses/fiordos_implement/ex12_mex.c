...
void mexFunction( int nlhs, mxArray *plhs[],
    ...
    ex12_Work work ={0};
    ex12_Params params ={0};
    ex12_Settings settings = {0};
    ex12_Result result = {0};

    /* initialize structs */
    ex12_init(&params, &settings, &result, &work);
    ...
    for (i=0; i<mxGetNumberOfFields(MPARAMS); ++i) {
        ...
        if ( mxGetM(tmp1) != 300 || mxGetN(tmp1) != 1 ) {
            mexErrMsgTxt("MPARAMS.g must be matrix of dimension 300x1.");
        }
        copyMArrayToC(mxGetPr(tmp1),params.g,300 );
        ...
        if ( mxGetM(tmp1) != 200 || mxGetN(tmp1) != 1 ) {
            mexErrMsgTxt("MPARAMS.be must be matrix of dimension 200x1.");
        }
        copyMArrayToC(mxGetPr(tmp1),params.be,200 );
        ...
        if ( 0 == strcmp(fname1,"algoInner")) {
            ...
            for (i2=0; i2<mxGetNumberOfFields(tmp1); ++i2) {
                ...
                if ( 0 == strcmp(fname2,"init")) {
                    ...
                    if ( mxGetM(tmp2) != 300 || mxGetN(tmp2) != 1 ) {
                        mexErrMsgTxt("MSETGS.algoInner.init must be matrix of dimension 300x1.");
                    }
                    copyMArrayToC(mxGetPr(tmp2),settings.algoInner.init,300);
                }
                else
        ...
        if ( 0 == strcmp(fname1,"algoOuter")) {
            ...
            for (i2=0; i2<mxGetNumberOfFields(tmp1); ++i2) {
                ...
                if ( 0 == strcmp(fname2,"init")) {
                    ...
                    if ( mxGetM(tmp2) != 200 || mxGetN(tmp2) != 1 ) {
                        mexErrMsgTxt("MSETGS.algoOuter.init must be matrix of dimension 200x1.");
                    }
                    copyMArrayToC(mxGetPr(tmp2),settings.algoOuter.init,200);
                }
                else
                if ( 0 == strcmp(fname2,"maxit")) {
                    if (!mxIsDouble(tmp2)) {
    ...
    /* call the solver */
    ex12_solve(&params, &settings, &result, &work);
    ...
    MRES = mxCreateStructMatrix(1,1, 5, fnames);
        tmp1 = mxCreateDoubleMatrix(200,1,mxREAL);
        copyCArrayToM( result.la, mxGetPr(tmp1), 200 );
        mxSetField(MRES, 0, "la", tmp1);
    
        tmp1 = mxCreateDoubleMatrix(300,1,mxREAL);
        copyCArrayToM( result.x, mxGetPr(tmp1), 300 );
