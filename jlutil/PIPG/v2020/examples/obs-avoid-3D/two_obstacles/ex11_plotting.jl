...
function trajectory3D(x,u,y)
	...
	% surf(r1*x1+p1(1),r1*y1+p1(2),z1,'EdgeAlpha',0.1,'FaceAlpha',0.5);
	surf(r3*x1+p3(1),r3*y1+p3(2),z1,'EdgeAlpha',0.1,'FaceAlpha',0.5);
	hold on
	surf(r2*x1+p2(1),r2*y1+p2(2),z1,'EdgeAlpha',0.1,'FaceAlpha',0.5);
