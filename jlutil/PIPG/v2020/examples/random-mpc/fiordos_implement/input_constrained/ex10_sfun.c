...
#include "ex10_solver.c"

#define S_FUNCTION_NAME   ex10_sfun   /**< Name of the S function. */
...
static void mdlInitializeSizes (SimStruct *S)
{
    ...
    if ( !ssSetNumOutputPorts(S, 5) )
    	return;     
    /* dimensions */
    ssSetOutputPortMatrixDimensions(S, 0, 40, 1);
    ssSetOutputPortMatrixDimensions(S, 1, 120, 1);
...
{
    /* allocate memory */
    ssGetPWork(S)[0] = (void *) calloc( 1, sizeof(ex10_Params) );
    ssGetPWork(S)[1] = (void *) calloc( 1, sizeof(ex10_Settings) );
    ssGetPWork(S)[2] = (void *) calloc( 1, sizeof(ex10_Result) );
    ssGetPWork(S)[3] = (void *) calloc( 1, sizeof(ex10_Work) );
    
    /* call init */
    ex10_init( (ex10_Params *) ssGetPWork(S)[0], (ex10_Settings *) ssGetPWork(S)[1], (ex10_Result *) ssGetPWork(S)[2], (ex10_Work *) ssGetPWork(S)[3] );
    
    /* adapt settings (from mask) */
    {
        ex10_Settings *settings = (ex10_Settings *) ssGetPWork(S)[1];
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    ex10_Params *params = (ex10_Params *) ssGetPWork(S)[0];
    ex10_Settings *settings = (ex10_Settings *) ssGetPWork(S)[1];
    ex10_Result *result = (ex10_Result *) ssGetPWork(S)[2];
    ex10_Work *work = (ex10_Work *) ssGetPWork(S)[3];
