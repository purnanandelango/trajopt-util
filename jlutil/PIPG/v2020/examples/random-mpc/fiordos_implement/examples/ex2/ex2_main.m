%% MPC example 2 for testing FiOrdOs
...
ZZ.addSet(N+(1:N),EssBox(nx,'l',xmin,'u',xmax));
...
s.setSettings('algoInner', 'stopg',true, 'stopgEps',1e-3);
s.generateCode('prefix','ex2_','forceOverwrite',true);
rehash;
ex2_mex_make;
