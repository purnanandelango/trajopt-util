...
% x_inert and t are nondimensional
% x_inert contains state vectors stacked along the columns
function [x_rot,T_inert_to_rot] = inert_to_rot(x_inert,t,astro)
    ...
    for j = 1:N
        ...
        x_inert_pos_dim  = x_inert(1:3,j)*astro.l_star; % l_star
        T_inert_to_rot   = [x_hat,y_hat,z_hat]';
        x_inert_vel_dim  = x_inert(4:6,j)*astro.v_star; % (l_star/t_star)
