...
%   wk            : nx x N-1
    ...
    for k = 1:N-1
        ...
        if nargin == 8
           [~,z_] = disc.rk4_march(@(t,z,u,p) foh_ode(t,z,u,p,func,func_linz,nx,nu,np,nx2,nxnu,nxnp,varargin{1}),tspan,zk,h_step,ufunc,[pbar;tspan]);
        elseif nargin == 7
...
function f = foh_ode(t,z,u,p,func,func_linz,nx,nu,np,nx2,nxnu,nxnp,varargin)
