function [Ak,Bmk,Bpk,Sk,wk,defect_traj,xbarprop] = compute_foh_v3(tbar,xbar,ubar,pbar,h,func,func_linz,varargin)
...
%   wk            : nx x N-1
    ...
    for k = 1:N-1
        ...
        if nargin == 8
            [~,z_tmp] = feval(varargin{1}{1},@(t,z) foh_ode(t,z,ufunc(t),[pbar;tspan],func,func_linz,nx,nu,np,nx2,nxnu,nxnp),tspan,zk,varargin{1}{2});
            z_ = z_tmp';
        elseif nargin == 7
