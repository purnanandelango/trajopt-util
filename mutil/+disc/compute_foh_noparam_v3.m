function [Ak,Bmk,Bpk,wk,defect_traj,xbarprop] = compute_foh_noparam_v3(tbar,xbar,ubar,h,func,func_linz,varargin)
...
%   wk            : nx x N-1
    ...
    for k = 1:N-1
        ...
        elseif nargin == 6
            ...
            error("Incorrect no. of arguments for compute_foh_noparam_v3.");
        end
        zkp1 = z_(:,end);
