function [Ak,Bk,wk,defect_traj,xbarprop] = compute_zoh_noparam_v1(tbar,xbar,ubar,h,func,func_linz,varargin)
...
%   xbarprop      : nx x N
    ...
    for k = 1:N-1
        ...
        if nargin == 7
            [~,z_tmp] = feval(varargin{1}{1},@(t,z) zoh_ode(t,z,ufunc(t),func,func_linz,nx,nx2),tspan,zk,varargin{1}{2});
            z_ = z_tmp';
        elseif nargin == 6
